    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h2 class="mb-1">Base Services</h2>
                    <p class="text-muted mb-0">Manage your core tailoring services</p>
                </div>
                ...
                <div class="service-card" draggable="true" onclick="flipCard(this)"
                    ...
                    <div class="card-front">
                        <div class="text-center">
                            <div class="service-category-badge">Base Service</div>
                    ...
                    <div class="card-back">
                        <div class="text-center mb-3">
                            ...
                            <div class="service-price mb-2" style="color: #405189;">Rs{{ number_format($service->price, 0) }}</div>
        ...
        <div class="modal-content">
            ...
            <form id="serviceForm">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="service_category" value="base">
...
function loadServices(search = '') {
    const url = new URL(window.location.origin + '/Dashboard/services/base');
    if (search) {
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 mb-4" data-service-id="${service.id}" style="transform: scale(0); opacity: 0;">
            <div class="service-card" draggable="true" onclick="flipCard(this)"
                ...
                <div class="card-back">
                    <div class="text-center mb-3">
                        <div class="service-title mb-2">${service.name}</div>
                        <div class="service-price mb-2" style="color: #405189;">Rs${Number(service.price).toLocaleString()}</div>
